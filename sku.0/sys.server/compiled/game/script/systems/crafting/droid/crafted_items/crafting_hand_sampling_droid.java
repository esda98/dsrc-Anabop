...
public class crafting_hand_sampling_droid extends script.systems.crafting.droid.crafting_base_droid_component
{
    public crafting_hand_sampling_droid()
    {
    }
    ...
    {
        new resource_weight("hsd_base_extraction_rate", new resource_weight.weight[]
        {
        ...
        new resource_weight("hsd_duration", new resource_weight.weight[]
        {
